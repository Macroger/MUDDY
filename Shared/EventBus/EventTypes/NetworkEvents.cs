...
namespace Shared.EventBus.EventTypes
{
    ...
    public class NetworkEvents
    {
        public class Commands
        {
            ...
            /// </summary>
            public sealed record BroadcastMessage(IReadOnlySet<ConnectionId> Recipients, TransportMessageType MessageType, string Message) : BusEvent(EventMessageType.Network, LogLevel.Trace);

            /// <summary>
            /// Represents an event that signals the start of a listener operation.
            /// </summary>
            public sealed record StartListner() : BusEvent(EventMessageType.Network, LogLevel.Information);
        ...
        public class Packets
        {
            ...
            /// </summary>
            public sealed record PacketSent(TransportEnvelope envelope) : BusEvent(EventMessageType.Network, LogLevel.Trace);

            public sealed record PacketReceived(TransportEnvelope envelope) : BusEvent(EventMessageType.Network, LogLevel.Trace);
        }
