...
{
    public class MessagePipelineEvents
    {
        public class Errors
        {
            /// <summary>
            ...
            public sealed record MessagePipelineError(string ErrorMessage, Exception? Exception = null) : BusEvent(EventMessageType.CmdPipeline, LogLevel.Error);
