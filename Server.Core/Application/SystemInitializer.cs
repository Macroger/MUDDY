...
namespace Server.Core.Application
{
    ...
    {
        private CommandPipelineOrchestrator _commandPipelineOrchestrator = null!;
        private LifecycleCoordinator _lifecycleCoordinator = null!;

        private IEventBus _eventBus = null!;
        private INetworkSupervisor _networkSupervisor = null!;

        private IMessageIdGenerator _messageIdGenerator = null!;
        private ISessionIdGenerator _sessionIdGenerator = null!;

        private IPlayerRepository _playerRepository = null!;
        private IWorldRepository _worldRepository = null!;

        private IChatService _chatService = null!;
        private IWorldMovementService _movementService = null!;
        ...
        public void Build()
        {
            ...
            _stateChangeToken = _eventBus.Subscribe<SystemEvents.Commands.ServerStateChangeRequest>(EventMessageType.System, OnServerStateChangeRequested);
        }
        ...
        public void StartServer()
        {
            ...
            {
                throw new InvalidOperationException("Build() must be called before StartServer().");
            }
